...
const NurseDashboard = () => {
  ...
  // Mock nurse data - matches Emily Rodriguez in data/nurses.js
  const currentNurse = {
    id: 1,
  ...
  const getPatientsPriorityCount = () => {
    const high = assignedPatients.filter(p => 
      ...
      p.currentCondition.toLowerCase().includes('crisis')
    ).length;
    ...
    const medium = assignedPatients.filter(p => 
      ...
      p.currentCondition.toLowerCase().includes('counseling')
    ).length;
  ...
  const todaysSchedule = [
    { time: '6:00 PM', patient: 'John Smith', procedure: 'Psychiatric Intake', status: 'upcoming' },
    { time: '7:30 PM', patient: 'Sarah Johnson', procedure: 'Panic Attack Therapy', status: 'upcoming' },
    { time: '8:30 PM', patient: 'Robert Davis', procedure: 'CBT Follow-up', status: 'completed' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            Welcome, <span className="text-indigo-600">{currentNurse.name}</span>
          </h1>
          <p className="text-xl text-gray-600">{currentNurse.title} Portal</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-bold text-purple-600">{todaysSchedule.length}</div>
                <div className="text-sm text-gray-600">Today's Consults</div>
              </div>
                ...
                {todaysSchedule.map((appointment, index) => (
                  <div key={index} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <div className="font-bold text-gray-800">{appointment.patient}</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                  ...
                  <p className="text-sm text-red-700">Require crisis/urgent assessment</p>
                </div>
                <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                  ...
                  <p className="text-sm text-amber-700">Treatment plans in progress</p>
                </div>
                <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
                  ...
                  <p className="text-sm text-emerald-700">Routine follow-ups</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'patients' && (
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              ...
              <Link
                to="/patients"
                className="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors shadow-md font-semibold"
              >
                ...
                {nurseReports.slice(0, 3).map((report) => (
                  <div key={report.id} className="p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <h4 className="font-semibold text-gray-800">{report.patientName}</h4>
