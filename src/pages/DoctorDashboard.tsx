      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            Doctor <span className="text-indigo-600">Dashboard</span>
          </h1>
          <p className="text-xl text-gray-600">Review reports and coordinate neuropsychiatric treatment plans</p>
        </div>
        ...
        {/* Navigation Tabs */}
        <div className="bg-white rounded-lg shadow-md mb-8 border border-gray-100">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              {pendingReports.length > 0 ? (
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-3 py-1 bg-indigo-600 text-white text-sm font-semibold rounded-md hover:bg-indigo-700 transition-colors"
                          >
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">All Reports Reviewed</h3>
                  <p className="text-gray-600">No clinical reports are pending review at this time</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {patients.map((patient) => (
                  <div key={patient.id} className="border border-gray-200 rounded-lg p-4 bg-white hover:shadow-md transition-shadow">
                    ...
                    <div className="mb-3">
                      ...
                      <p className="text-sm text-gray-600">
                        <strong>Counselor:</strong> {patient.assignedNurse}
                      </p>
                    </div>
                    
                    <div className="flex items-center text-xs text-gray-500">
                      <Calendar className="h-3 w-3 mr-1" />
                      Next Consultation: {new Date(patient.nextAppointment).toLocaleDateString()}
                    </div>
                  </div>
                ))}
              </div>
        ...
        {activeTab === 'staff' && (
          <div className="space-y-8">
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Counselor Performance</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {nurses.map((nurse) => {
                  ...
                  return (
                    <div key={nurse.id} className="border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-shadow">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <div className="text-2xl font-bold text-indigo-600">{nursePatients.length}</div>
                          <div className="text-sm text-gray-600">Active Case Files</div>
                        </div>
                        <div>
        ...
        {selectedReport && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-screen overflow-y-auto p-8 border border-gray-100">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">{selectedReport.patientName}</h2>
                  <p className="text-gray-600">Clinical Report by {selectedReport.nurseName}</p>
                  <p className="text-sm text-gray-500">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <h4 className="font-medium text-gray-850 mb-1">Blood Pressure</h4>
                    <p className="text-gray-600">{selectedReport.vitals.bloodPressure}</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-850 mb-1">Temperature</h4>
                    <p className="text-gray-600">{selectedReport.vitals.temperature}</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-850 mb-1">Pulse Rate</h4>
                    <p className="text-gray-600">{selectedReport.vitals.pulse}</p>
                  </div>
                </div>

                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Procedures / Interventions Performed</h3>
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    ...
                    Doctor Feedback / Prescription Notes
                  </label>
                  <textarea
                    value={feedback}
                    ...
                    placeholder="Add feedback, prescriptions, and instructions..."
                  />
                </div>
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className="flex-1 bg-emerald-600 text-white py-3 px-6 rounded-lg hover:bg-emerald-700 transition-colors font-semibold shadow-md"
                  >
                    Approve Report & Sign Off
                  </button>
                  <button
                    onClick={() => setSelectedReport(null)}
